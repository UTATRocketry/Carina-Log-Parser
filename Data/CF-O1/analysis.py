...
def fill_study():
    ...
    sensors_df = sensors_df[(sensors_df["Time"] >= -920) & (sensors_df["Time"] <= -100)]
...
def flow_study():
    ...
    lns2 = ax1.plot(sensors_df["Time"], sensors_df["POTT"], color="purple")
    ...
    ax1.legend(lns1+lns2+lns3, ["POTB", "POTT", "MOT"], loc="upper right")
